...
final class FiberHelper {
    static /*Executable*/ Member lookupMethod(ExtendedStackTraceElement ste) {
    ...
    static Pair<Boolean, Instrumented> isCallSiteInstrumented(/*Executable*/ Member m, int sourceLine, int bci, ExtendedStackTraceElement[] stes, int currentSteIdx) {
        if (m == null)
